...
if (os.getenv('SERVER_SOFTWARE', '').startswith('Google App Engine') or
    ...
    DATABASES = {
        'default': {
            ...
            'INSTANCE': 'slskcloudproject:slskinstance',
            'NAME': 'slskcloud_db',
        }
    }
else:
...
SECRET_KEY = ')7yg913%cr&9(8ap&f4f%up$nc##d0t+v!9ov4#v(ribphujuk'
